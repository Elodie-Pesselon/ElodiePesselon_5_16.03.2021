...
var data = null; // ---------- Création d'une fonction permettant de générer la page produit automatiquement --------- // 
...
getTeddyId(); // Création d'une fonction permettant de générer la liste des couleurs disponibles en fonction de l'ID
